  ...
  return (
    <div className="min-h-screen bg-white sm:bg-gray-50" aria-busy="true" aria-label="Loading product">
      ...
      <div className="mx-auto max-w-[1536px] animate-pulse px-3 pb-24 pt-4 sm:px-4 sm:pt-6 lg:pb-8">
        {/* Breadcrumb */}
        <div className="mb-4 h-4 w-64 rounded-md bg-gray-200" />

        <div className="flex flex-col gap-6 lg:flex-row lg:items-start">
          {/* Gallery */}
          <div className="min-w-0 lg:w-[62%]">
            <div className="aspect-square w-full rounded-md bg-gray-200 sm:aspect-[4/3]" />
            <div className="mt-3 hidden gap-2 sm:flex">
              {Array.from({ length: 5 }).map((_, i) => (
                <div key={i} className="h-16 w-16 flex-shrink-0 rounded-md bg-gray-200" />
              ))}
            </div>
          </div>
          ...
          <div className="min-w-0 space-y-4 lg:w-[38%]">
            ...
            <div className="h-9 w-32 rounded-md bg-gray-200" /> {/* price */}
            <div className="h-12 w-full rounded-md bg-gray-200" /> {/* primary CTA */}
            <div className="h-12 w-full rounded-md bg-gray-100" /> {/* secondary CTA */}

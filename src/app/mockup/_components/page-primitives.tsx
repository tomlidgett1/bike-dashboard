// ─────────────────────────────────────────────────────────────────────────────
// Page-level layout primitives — the shared "style sheet" for every page.
//
// Every page in the dashboard composes these so spacing, type scale and
// alignment are identical everywhere. Change it here → it changes everywhere.
// ─────────────────────────────────────────────────────────────────────────────
...
/**
 * Standard page heading: eyebrow / title / description on the left,
 * a slot for primary actions on the right. Identical on every page.
 */

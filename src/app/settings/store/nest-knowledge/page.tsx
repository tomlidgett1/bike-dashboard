...
import { NestKnowledgeWorkspace } from "@/components/settings/nest-workspace/nest-knowledge-workspace";

function NestWorkspaceFallback() {
  return (
    <div
...
export default function NestKnowledgePage() {
  return (
    <Suspense fallback={<NestWorkspaceFallback />}>
      <NestKnowledgeWorkspace />
    </Suspense>
  );
}

...
import { ArrowUpRight, ChevronDown, History, Pencil, Plus, ScanSearch, ThumbsDown, ThumbsUp, Trash2, X } from "lucide-react";
...
import { GenieLessonsButton } from "@/components/genie/genie-lessons-panel";
...
function DeepReviewLaunchButton({
  onClick,
  disabled,
}: {
  onClick: () => void;
  ...
  return (
    <button
      ...
      className="inline-flex items-center gap-1.5 rounded-full bg-gradient-to-br from-amber-500 to-yellow-500 px-3 py-1.5 text-xs font-semibold text-white shadow-sm transition hover:from-amber-600 hover:to-yellow-600 disabled:cursor-not-allowed disabled:opacity-50"
    >
        ...
        <HomePageQuietLayout
          ...
          toolbar={
            <div className="flex items-center justify-end gap-1.5">
              <DeepReviewLaunchButton onClick={startDeepReview} disabled={isLoading} />

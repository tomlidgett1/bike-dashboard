...
// (src/lib/nest-portal/api/brand-portal-outbound.ts) via the Vercel->Next adapter. Do not add logic here.
import { type NextRequest } from "next/server";
import handler from "@/lib/nest-portal/api/brand-portal-outbound";

...
export default async function PayRequestPage({
  ...
  return (
    <PageShell>
      ...
      <p className="mt-2 text-4xl font-semibold tracking-tight text-gray-900">{amount}</p>
      {paymentRequest.description ? (
        <p className="mt-2 text-sm text-gray-600">{paymentRequest.description}</p>
      ) : null}
      ...
      <p className="mt-4 text-xs leading-relaxed text-gray-400">
        Payments are processed securely by Stripe. Once paid, {amount} is added to

...
import { ArrowLeft, ArrowRight } from "@/components/layout/app-sidebar/dashboard-icons";
...
export function CatalogueOptimiseFlow({ onBack }: { onBack: () => void }) {
  ...
  return (
    <div className="space-y-4">
      ...
      {step === "copy" && (
        <>
          <CopyQueue fixedScope="catalogue" />
      ...
      {step === "photos" && <PhotoQueue fixedScope="catalogue" />}
    </div>
  );
}

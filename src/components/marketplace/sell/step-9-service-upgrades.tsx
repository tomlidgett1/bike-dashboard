...
// ============================================================
// Step 9: Service & Upgrades
// ============================================================

interface Step9ServiceUpgradesProps {
  data: HistoryFormData;
  onChange: (data: HistoryFormData) => void;
  errors?: ValidationError[];
}

export function Step9ServiceUpgrades({ data, onChange, errors = [] }: Step9ServiceUpgradesProps) {
  ...
  return (
    <div className="max-w-4xl mx-auto space-y-8">
      ...
      <div className="text-center space-y-2">
        <h2 className="text-2xl font-bold text-gray-900">Service & Upgrades</h2>
        <p className="text-gray-600">
          Maintenance history and any upgrades you've made
        </p>
      </div>

...
// On mobile, shows a larger card during processing.
// ============================================================
        ...
        <>
                    ...
                    <div className="flex items-center gap-3 mb-3">
                      ...
                      <div className="h-10 w-10 rounded-full bg-gray-100 flex items-center justify-center flex-shrink-0">
                        <motion.div
                          ...
                          className="h-5 w-5 border-2 border-gray-300 border-t-[#FFC72C] rounded-full"
                        />
                      </div>
          ...
          <motion.div
            ...
            className={cn(
              ...
              "sm:w-[320px]",
              // Hide on mobile when processing (expanded card shows instead)
              isProcessing && "hidden sm:block"
            )}
          >
            <div 
              className={cn(

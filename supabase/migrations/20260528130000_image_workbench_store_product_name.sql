-- ============================================================
-- Add store product name to image_workbench_products
-- Picks one representative product description from linked
-- store products so the workbench shows the real name rather
-- than the (often mangled) canonical normalized_name.
-- ============================================================
...
SELECT
  ...
  -- Aggregate SOH and price from linked store products
  ...
  -- Representative store product name (actual product name, not canonical)
...
COMMENT ON VIEW image_workbench_products IS
  'Canonical products with image review counts, primary image state, aggregate SOH/price, and a representative store product name from linked store products.';

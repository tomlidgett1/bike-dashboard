...
-- Drop materialized view that depends on images column
DROP MATERIALIZED VIEW IF EXISTS products_with_images CASCADE;

-- Drop trigger that depends on images column
DROP TRIGGER IF EXISTS trg_update_product_cached_images ON products;
DROP FUNCTION IF EXISTS update_product_cached_images() CASCADE;

-- ============================================================
-- Step 2: Drop Deprecated Sync Functions
-- ============================================================
...
-- ============================================================
-- Step 3: Drop Deprecated Columns from products table
-- ============================================================

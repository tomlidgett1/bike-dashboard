-- ============================================================
-- FIX: CONVERSATION DETAIL FUNCTION - Remove UPDATE
-- ============================================================
-- Removed UPDATE statement to keep function STABLE for performance
-- Mark as read will be handled by the API separately

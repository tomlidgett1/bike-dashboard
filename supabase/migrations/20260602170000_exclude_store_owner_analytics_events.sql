-- Exclude authenticated store-owner traffic from analytics summaries.
-- The API also ignores new owner events; this keeps historical/reporting reads
-- correct if any owner events were recorded before that guard existed.

-- Bucket daily analytics on Australia/Melbourne calendar days (not UTC midnight).
...
COMMENT ON FUNCTION get_store_analytics_summary(UUID, INTEGER) IS
  'Store analytics summary. Event timestamps are stored in UTC; daily buckets use Australia/Melbourne calendar days.';
